...
public class JobSeekerController {
	...
	//http://localhost:9009/jobseeker/login
	...
	public Education getEducation(@PathVariable("jobseekerid") int id) {
		Education edu =new Education();
		edu = daoImpl.getEducation(id);
		return edu;
	}
	...
	//http://localhost:9009/jobseeker/deleteexp?expid=1
	...
	//http://localhost:9009/jobseeker/getexperiencebyid/2
	@GetMapping(value = "/getexperiencebyid/{expid}")
	public Experience getExperience(@PathVariable("expid") int id) {
		Experience exp =daoImpl.getExperienceById(id);
		
		return exp;
	}
	
	//http://localhost:9009/jobseeker/geteducationbyid/2
	@GetMapping(value = "/geteducationbyid/{educationid}")
	public Education getEducationById(@PathVariable("educationid") int id) {
		Education edu =daoImpl.getEducationById(id);
